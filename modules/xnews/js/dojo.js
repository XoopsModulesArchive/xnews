...
if (typeof dojo == "undefined") {
    ...
    dojo.version = {
        major: 0, minor: 4, patch: 1, flag: "", revision: Number("$Rev: 6824 $".match(/[0-9]+/)[0]), toString: function () {
            with (dojo.version) {
    ...
    (function () {
        var _26 = {
            pkgFileName: "__package__", loading_modules_: {}, loaded_modules_: {}, addedToLoadingCount: [], removedFromLoadingCount: [], inFlightCount: 0, modulePrefixes_: {dojo: {name: "dojo", value: "src"}}, setModulePrefix: function (_27, _28) {
...
dojo.lang.extend(dojo.io.Request, {
    url: "", mimetype: "text/plain", method: "GET", content: undefined, transport: undefined, changeUrl: undefined, formNode: undefined, sync: false, bindSuccess: false, useCache: false, preventCache: false, load: function (type, data, _14d, _14e) {
...
dojo.undo.browser = {
    initialHref: (!dj_undef("window")) ? window.location.href : "", initialHash: (!dj_undef("window")) ? window.location.hash : "", moveForward: false, historyStack: [], forwardStack: [], historyIframe: null, bookmarkAnchor: null, locationTimer: null, setInitialState: function (args) {
...
dojo.lang.extend(dojo.lfx.IAnimation, {
    curve: null, duration: 1000, easing: null, repeatCount: 0, rate: 25, handler: null, beforeBegin: null, onBegin: null, onAnimate: null, onEnd: null, onPlay: null, onPause: null, onStop: null, play: null, pause: null, stop: null, connect: function (evt, _3d0, _3d1) {
        if (!_3d1) {
            _3d1 = _3d0;
            _3d0 = this;
        }
...
dojo.lang.extend(dojo.lfx.Animation, {
    _startTime: null, _endTime: null, _timer: null, _percent: 0, _startRepeatCount: 0, play: function (_3de, _3df) {
        if (_3df) {
...
dojo.lang.extend(dojo.lfx.Combine, {
    _animsEnded: 0, play: function (_3ee, _3ef) {
...
dojo.lang.extend(dojo.lfx.Chain, {
    _currAnim: -1, play: function (_3fc, _3fd) {
        if (!this._anims.length) {
            return this;
        }
...
dojo.lfx.html.explode = function (_5b6, _5b7, _5b8, _5b9, _5ba) {
    ...
    var anim = new dojo.lfx.propertyAnimation(_5bd, _5c0, _5b8, _5b9, {
        "beforeBegin": function () {
...
dojo.lfx.html.implode = function (_5c3, end, _5c5, _5c6, _5c7) {
    ...
    var anim = new dojo.lfx.propertyAnimation(_5cb, _5cc, _5c5, _5c6, {
        "beforeBegin": function () {
            dojo.html.hide(_5c3);
            dojo.html.show(_5cb);
        }, "onEnd": function () {
...
dojo.lfx.html.highlight = function (_5cf, _5d0, _5d1, _5d2, _5d3) {
    ...
    dojo.lang.forEach(_5cf, function (node) {
        ...
        var anim = dojo.lfx.propertyAnimation(node, {"background-color": {start: rgb, end: _5db}}, _5d1, _5d2, {
            "beforeBegin": function () {
                if (_5d8) {
...
dojo.lfx.html.unhighlight = function (_5dd, _5de, _5df, _5e0, _5e1) {
    ...
    dojo.lang.forEach(_5dd, function (node) {
        ...
        var anim = dojo.lfx.propertyAnimation(node, {"background-color": {start: _5e4, end: rgb}}, _5df, _5e0, {
            "beforeBegin": function () {
                if (_5e6) {
                    node.style.backgroundImage = "none";
                }
